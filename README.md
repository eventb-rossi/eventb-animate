...
```yaml
- uses: eventb-rossi/eventb-animate@v6.3
  with:
...
```yaml
include:
  - remote: 'https://raw.githubusercontent.com/eventb-rossi/eventb-animate/v6.3/.gitlab-ci-template.yml'
...
| `EVENTB_ANIMATE_VERSION` | Release version tag (e.g., `v6.3`) | `latest` |
