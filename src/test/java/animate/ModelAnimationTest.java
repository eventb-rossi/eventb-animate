...
/**
 * Test that verifies Event-B models can be loaded and animated.
 * Tests models from https://github.com/17451k/eventb-models
 */
        ...
        try {
            ...
            for (int i = 0; i < ANIMATION_STEPS; i++) {
                try {
                    ...
                    System.out.println("  ⚠ Animation stopped after " + successfulSteps + " steps: " + e.getMessage());
                    break;
                }
            }
